...
def onClick_Button():
    ...
    print("2")
    print("widget.geometry().x()=%d" % widget.geometry().x())  # 259 （工作区横坐标）
    print("widget.geometry().y()=%d" % widget.geometry().y())  # 238 （工作区横坐标）
    ...
    print("widget.frameGeometry().width()=%d" % widget.frameGeometry().width())  # 318 （窗口宽度）
    print("widget.frameGeometry().height()=%d" % widget.frameGeometry().height())  # 287 （窗口高度）
